...
int main(int args, char* argv[]){
    ...
    if (args <= 1 || strcmp(argv[1],"-skip") != 0) {
        ...
        cout << "\033[0mTheir leader is hiding in the \033[91m" << flush;
        ...
        cout << "\033[0mYou must go and find the \033[92m" << flush;
    ...
    while(player.isAlive() && !player.HasReachedHideout()){
        //print the map
        //top row
        for (int i=0;i<3;i++) {
            for (int j=0;j<5;j++) {
